...
<footer>
    <div>
        <div class="w-6-12 lft-txt" style="width: 100%;">
            ...
            <p>использует товарный знак “ПЕРСОНА имидж-лаборатория” по лицензии от правообладателя, регистрация в Роспатенте от 30.09.2016 №РД0207279</p>
            <p>Салоны, представленные на Сайте, являются самостоятельными юридическими лицами и несут исключительную ответственность за свою деятельность, осуществляемую в рамках договора франшизы.

                Если вы являетесь правообладателем материалов, размещённых на сайте (включая изображения и фотографии), и считаете, что их использование нарушает ваши права, или возражаете против их использования, пожалуйста, свяжитесь с нами: <a href="mailto:info@persona-city.ru">info@persona-city.ru</a></p>
        </div>
